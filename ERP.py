...
############################# EEGNet portion ##################################
Y_train = torch.nn.functional.one_hot(torch.as_tensor(Y_train - 1)).to(device)
Y_validate = torch.nn.functional.one_hot(torch.as_tensor(Y_validate - 1)).to(device)
Y_test = torch.nn.functional.one_hot(torch.as_tensor(Y_test - 1)).to(device)
